...
class BotMessage(object):
    common_text = "\n\n<u>If you are facing any problem, so report at @Suport_Badsha_Studios</u>"
    ...
    start_msg = f"<b>Hi, I am URL_UploaderBot Created by @Badsha_Bot_Updates and My Developer is @kingBadsha3232.</b>\n{help_msg}"
